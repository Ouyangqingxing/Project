...
//        // 鍙戝ご鎺у埗娴忚鍣ㄤ笉瑕佺紦瀛�        response.setDateHeader("expries", -1);
...
//    }
// 
//    // 鐢婚殢鏈虹嚎骞叉壈绾�    private void drawRandomLine(Graphics g) 
//    {
//        // 璁剧疆棰滆壊
//        g.setColor(Color.GREEN);
//        // 璁剧疆绾挎潯涓暟骞剁敾骞叉壈绾�        for (int i = 0; i < 5; i++) {
...
//    }
//
//    //鐢婚殢鏈烘眽瀛�    private String drawRandomNum(Graphics2D g)
//    {
