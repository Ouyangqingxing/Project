...
//
//
//import fs.battle.dao.TeamJobDaoByUser;
//import fs.battle.model.TeamJob;
//
//public class TeamJobDaoImpU implements TeamJobDaoByUser
//{
//	@Override
...
//
//	@Override
//	public TeamJob daoSelectTeamJobByTeamId(Connection conn, int teamId)
//			throws SQLException
//	{ 
//		PreparedStatement ps = null;
//		ResultSet rs = null;
//		
//			String sql = "select teamjob_id,teamjob_oneName,teamjob_twoName,teamjob_threeName,teamjob_fourName,teamjob_fiveName " +
//					" from teamjob where team_id = ? ";
//			ps = conn.prepareStatement(sql);
//			ps.setInt(1, teamId);
//			rs = ps.executeQuery();
//			rs.next();
